...
final class LangPredefinedFunctions {
	...
	private void addPredefinedCombinatorFunctions(Map<String, LangPredefinedFunctionObject> funcs) {
		...
		funcs.put("combAV", combinatorFunctionExternalFunctionObjectHelper(2, new int[] {0}, (Combinator2ArgFunction)(a, b, SCOPE_ID) -> {
			FunctionPointerObject aFunc = a.getFunctionPointer();
			
			if(b.getType() != DataType.ARRAY)
		...
		funcs.put("combB0", combinatorFunctionExternalFunctionObjectHelper(2, new int[] {0, 1}, (Combinator2ArgFunction)(a, b, INNER_SCOPE_ID) -> {
			FunctionPointerObject aFunc = a.getFunctionPointer();
